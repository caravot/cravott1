...
import com.bdb.api.exception.BreweryDBException;
import com.bdb.api.json.GsonFactory;
import com.bdb.api.model.*;
import com.bdb.api.request.beer.GetBeersRequest;
import com.bdb.api.request.beer.GetRandomBeerRequest;
import com.bdb.api.request.brewery.GetBreweriesRequest;
import com.bdb.api.request.brewery.GetBreweryRequest;
import com.bdb.api.request.feature.GetFeaturesRequest;
import com.bdb.api.request.ingredient.GetIngredientsRequest;
import com.bdb.api.result.Result;
import com.bdb.api.result.beer.AddBeerResult;
import com.bdb.api.result.beer.GetBeerResult;
import com.bdb.api.result.beer.GetBeersResult;
import com.bdb.api.result.beer.GetRandomBeerResult;
import com.bdb.api.result.brewery.GetBreweriesResult;
import com.bdb.api.result.category.GetCategoriesResult;
import com.bdb.api.result.category.GetCategoryResult;
import com.bdb.api.result.feature.FeaturedResult;
import com.bdb.api.result.glass.GetGlassesResult;
import com.bdb.api.result.hop.GetHopsResult;
import com.bdb.api.result.style.GetStyleResult;
import com.bdb.api.result.style.GetStylesResult;
import com.bdb.api.config.Configuration;
import com.bdb.api.exception.MissingApiKeyException;
import com.bdb.api.request.ApiRequest;
import com.bdb.api.request.beer.AddBeerRequest;
import com.bdb.api.request.beer.GetBeerRequest;
import com.bdb.api.request.beer.UpdateBeerRequest;
import com.bdb.api.request.hop.GetHopsRequest;
import com.bdb.api.result.hop.GetHopResult;
import com.bdb.api.result.beer.DeleteBeerResult;
import com.bdb.api.result.beer.UpdateBeerResult;
import com.bdb.api.result.brewery.GetBreweryResult;
import com.bdb.api.result.feature.FeaturesResult;
import com.bdb.api.result.glass.GetGlassResult;
import com.bdb.api.result.ingredient.GetIngredientResult;
import com.bdb.api.result.ingredient.GetIngredientsResult;
...
public class BreweryDBClient {
    ...
    /**
     * Returns a list of all {@link Category Categories}.
     *
     ...
     *
     * @param id The ID of the {@link Category} to retrieve.
    ...
    /**
     * Returns a list of {@link Style Styles}.
     *
    ...
    /**
     * Returns a {@link Style} by ID.
     *
     * @param id The ID of the {@link Style} to retrieve.
    ...
    /**
     * Returns a list of {@link Glass Glasses}.
     */
    ...
    /**
     * Returns a list of {@link Hop Hops}.
     */
    ...
    /**
     * Returns a list of {@link Hop Hops} by page.
    ...
    /**
     * Returns a list of {@link Ingredient Ingredients} by page.
     * @param request The filter for this request.
    ...
    /**
     * Retrieves an {@link Ingredient} by its ID.
